...
//	}
	...
	if (gl_InvocationID == 0)
	{
        ...
        //float d00 = length(gl_in[0].gl_Position.xz - ViewPosition.xz);
        //float d01 = length(gl_in[1].gl_Position.xz - ViewPosition.xz);
        //float d10 = length(gl_in[2].gl_Position.xz - ViewPosition.xz);
        //float d11 = length(gl_in[3].gl_Position.xz - ViewPosition.xz);
